...
function AirtelMoneyForm({ plan, onSuccess }: { plan: typeof PLANS.monthly; onSuccess: () => void }) {
  const [phoneNumber, setPhoneNumber] = useState("");
...
function ZellePaymentForm({ plan, onSuccess }: { plan: typeof PLANS.monthly; onSuccess: () => void }) {
