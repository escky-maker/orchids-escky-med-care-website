...
const FORM_STORAGE_KEY = "signup_form_state";
const FORM_EXPIRY_MS = 30000;
...
export default function SignUpPage() {
  ...
  useEffect(() => {
    ...
    if (savedState) {
      try {
        ...
        if (now - timestamp < FORM_EXPIRY_MS) {
          setEmail(data.email || "");
          setPassword(data.password || "");
          setConfirmPassword(data.confirmPassword || "");
          setStep(data.step || "signup");
  ...
  }, [email, password, confirmPassword, step, verificationCode, success]);
