          ...
          >
            <Card className="h-full border-2 border-rose-400 relative overflow-hidden shadow-xl">
              ...
              <CardHeader className="pb-4">
                ...
                <div className="mt-4">
                  <span className="text-5xl font-bold text-slate-900">$285</span>
                  <span className="text-slate-500">/year</span>
                  <div className="mt-1">
                    <span className="text-sm text-slate-500 line-through">$300/year</span>
                    <span className="text-sm text-green-600 ml-2 font-medium">Save $15</span>
                  </div>
                </div>
              </CardHeader>
              <CardContent>
