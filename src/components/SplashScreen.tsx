  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-600 via-rose-600 to-pink-700 dark:from-orange-900 dark:via-rose-900 dark:to-pink-900 flex items-center justify-center px-6 py-12 overflow-hidden relative">
      <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-20"></div>
        ...
        >
          <div className="relative" style={{ transformStyle: "preserve-3d", transform: "rotateY(8deg) rotateX(-3deg)" }}>
            <div className="absolute inset-0 bg-amber-300/30 rounded-full blur-3xl" style={{ transform: "translateZ(-30px)" }}></div>
            <svg className="w-24 h-24 md:w-32 md:h-32 lg:w-40 lg:h-40" viewBox="0 0 150 150" xmlns="http://www.w3.org/2000/svg" style={{ filter: "drop-shadow(6px 8px 15px rgba(245, 158, 11, 0.4)) drop-shadow(-3px -4px 12px rgba(254, 243, 199, 0.3))", transform: "translateZ(0px)" }}>
              <defs>
                <linearGradient id="childBodyGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" style={{ stopColor: "#ffffff", stopOpacity: 1 }} />
                  <stop offset="100%" style={{ stopColor: "#fed7aa", stopOpacity: 0.9 }} />
                </linearGradient>
                <radialGradient id="childCheek" cx="50%" cy="50%" r="50%">
                  <stop offset="0%" style={{ stopColor: "#fdba74", stopOpacity: 0.5 }} />
                  <stop offset="100%" style={{ stopColor: "#fb923c", stopOpacity: 0 }} />
                </radialGradient>
              </defs>
              <ellipse cx="75" cy="120" rx="30" ry="20" fill="#fdba74" opacity="0.2" />
              <ellipse cx="75" cy="90" rx="28" ry="35" fill="url(#childBodyGradient)" style={{ filter: "drop-shadow(2px 4px 5px rgba(245, 158, 11, 0.3))" }}/>
              <circle cx="75" cy="45" r="22" fill="url(#childBodyGradient)" style={{ filter: "drop-shadow(2px 3px 4px rgba(245, 158, 11, 0.3))" }}/>
              <ellipse cx="65" cy="48" rx="6" ry="5" fill="url(#childCheek)" />
              <ellipse cx="85" cy="48" rx="6" ry="5" fill="url(#childCheek)" />
              <circle cx="72" cy="42" r="3" fill="#f59e0b" style={{ filter: "drop-shadow(1px 1px 2px rgba(0, 0, 0, 0.3))" }}/>
              <circle cx="78" cy="42" r="3" fill="#f59e0b" style={{ filter: "drop-shadow(1px 1px 2px rgba(0, 0, 0, 0.3))" }}/>
              <circle cx="70" cy="41" r="1" fill="#ffffff" opacity="0.8" />
              <circle cx="76" cy="41" r="1" fill="#ffffff" opacity="0.8" />
              <path d="M70 50 Q75 54 80 50" stroke="#f59e0b" strokeWidth="2" fill="none" style={{ filter: "drop-shadow(1px 1px 2px rgba(0, 0, 0, 0.2))" }}/>
              <path d="M60 50 Q55 45 50 50" stroke="url(#childBodyGradient)" strokeWidth="4" fill="none" style={{ filter: "drop-shadow(2px 2px 3px rgba(245, 158, 11, 0.3))" }}/>
              <path d="M90 50 Q95 45 100 50" stroke="url(#childBodyGradient)" strokeWidth="4" fill="none" style={{ filter: "drop-shadow(2px 2px 3px rgba(245, 158, 11, 0.3))" }}/>
              <circle cx="75" cy="35" r="4" fill="#fed7aa" opacity="0.6" style={{ filter: "drop-shadow(1px 1px 2px rgba(245, 158, 11, 0.2))" }}/>
            </svg>
          </div>
        </motion.div>
